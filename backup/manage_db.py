...
# # --- 상수 정의 ---
# DB_PATH = Path("faiss_db.json")
# DB_PERMANENT_PATH = Path("faiss_db_permanent.json")
...
def clear_db():
    ...
    files_to_delete = [DB_PATH, INDEX_PATH]
...
def rebuild_db():
    ...
    # 6. 인덱스 파일 저장
    try:
        print(f"Serializing and writing index to {INDEX_PATH}...")
