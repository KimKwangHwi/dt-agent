...
BACKEND_MANUAL_DIR = Path(__file__).resolve().parent.parent / "backend" / "manual"
MD_PATH = BACKEND_MANUAL_DIR / "torus.md"
TORUS_MD_CONTENT = ""
try:
...
JSON_PATH = BACKEND_MANUAL_DIR / "uri_params.json"
...
async def main():
    ...
    # llm = ChatAnthropic(temperature=0, model="claude-haiku-4-0")
